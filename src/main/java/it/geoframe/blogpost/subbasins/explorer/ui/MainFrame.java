...
public final class MainFrame extends JFrame implements LoadFileController.Navigator {
    ...
    public void goHome(ProjectConfig cfg) {
        // Qui quando vuoi, puoi passare cfg alla Home e farci partire i servizi.
        Home home = new Home("0.1.0-SNAPSHOT");
        // in un secondo step: Home(ProjectConfig cfg, String version)
        setContentPane(home.getContentPane());
        revalidate();
        repaint();
    }
}